...
params = {'dropout': [0.25, 0.25], 'classifier': 'CRF', 'LSTM-Size': [100], 'optimizer': 'nadam',
          'charEmbeddings': None, 'miniBatchSize': 32}

frequencyThresholdUnknownTokens = 50
# If a token that is not in the pre-trained embeddings file appears at least 50 times in the train.txt, then a new
# embedding is generated for this word
